...
function itHasTheCorrectEventProperties() {
...
function itHasTheCorrectMarkerPlacementProperties() {
    const item = items[0],
...
function itHasTheCorrectNativeMarkerPlacementProperties() {
    const item = items[0],
...
function itHasCorrectPolylinePlacemarkProperties() {
    const item = items[1],
        points = [
...
function itHasCorrectNativePolylinePlacemarks() {
    const item = items[1],
        nativePlacemark = item.getNativePlacemark();
    expect( nativePlacemark ).not.toBeNull();
    expect( nativePlacemark ).toBeDefined();
...
describe("loadtests", function() {
    ...
    it("has the correct event properties", itHasTheCorrectEventProperties);
    it("has the correct marker placemark properties",
       itHasTheCorrectMarkerPlacementProperties);
    it("has the correct native marker placement properties",
       itHasTheCorrectNativeMarkerPlacementProperties);
